<?php
  $lang = array(
    ...
    'not_ready' => ' <span class="hg">HistoGlobe</span> visualises history on a digital map of the world.
    ...
    'summary_head' => '<span class="hg">HistoGlobe</span> visualizes history:
      Modern, interactive and informative.</span>',

    'summary' => '<p> <span class="hg">HistoGlobe</span> shows historical events and developments on a three
    ...
    'explanation_1' => '<p> <span class="hg">HistoGlobe</span> unites means of teaching and learning: teachers
     ...
     </p><p>If you want to learn more, feel free to write an e-mail at
      <a href="mailto:info@histoglobe.com">info@histoglobe.com</a>.</p>',

    'explanation_2' => '<p> <span class="hg">HistoGlobe</span> offers a unique way to emphasise, connect and
      combine certain themes or artifacts within the exhibitions. As an interactive
      tool it enables users to discover history according to their needs.  <span class="hg">HistoGlobe</span>
      highlights both historical regions on a digital map as well as time frames on
      the timeline.
      </p><p>If you want to learn more, feel free to write an e-mail at
      <a href="mailto:info@histoglobe.com">info@histoglobe.com</a>.</p>',

    'explanation_3' => '<p>With  <span class="hg">HistoGlobe</span> you can show your own history. Use it to
      ...
      way. As a marketing tool or as a means of internal or external communication:
       <span class="hg">HistoGlobe</span> offers a unique way to show your past and future developments.
      </p><p>If you want to learn more, feel free to write an e-mail at
      <a href="mailto:info@histoglobe.com">info@histoglobe.com</a>.</p>',
