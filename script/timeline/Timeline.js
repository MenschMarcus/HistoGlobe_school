...
HG.Timeline = (function() {
  function Timeline(config) {
    ...
    var defaultConfig, epoch1, epoch2;
    ...
    epoch1 = {
      startDate: this.yearToDate(1995),
      endDate: this.yearToDate(2000),
      name: "Wende!"
    };
    epoch2 = {
      startDate: this.yearToDate(2003),
      endDate: this.yearToDate(2006),
      name: "Wende! 3"
    };
    defaultConfig = {
      parentDiv: void 0,
  ...
  Timeline.prototype._updateEpochs = function() {
    ...
    if (this._uiElements.epochs.getLength() === 0) {
      _ref = this._config.epochs;
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        epoch = _ref[_i];
        this._div = document.createElement("div");
        this._div.id = "epoch" + epoch.name;
        this._div.className = "tl_epoch";
        this._div.innerHTML = epoch.name;
        this._div.style.left = this.dateToPosition(epoch.startDate) + "px";
        this._div.style.display = "none";
        this._div.style.width = (this.dateToPosition(epoch.endDate) - this.dateToPosition(epoch.startDate)) + "px";
        this.getCanvas().appendChild(this._div);
        $(this._div).fadeIn(200);
        _results.push(this._uiElements.epochs.addLast(this._div));
      }
      return _results;
    }
  };
