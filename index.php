...
-->
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function($) {
        ...
        var gallery = new HG.TimeGalleryWidget({
          icon: "fa-tags",
          name: "Gallerie"
        });
